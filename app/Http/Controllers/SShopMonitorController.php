...
class SShopMonitorController extends Controller
{
  ...
  public function index()
  {
    ...
    return view('user-panel.s-shop-monitor.index', compact('blockchains', 'lockersRecords', 'vendings', 'ledPrice', 'ledSensor', 'ledString', 'blockchainStream', 'newOrder', 'orderCount', 'totalOrderCount', 'userCount', 'productCount', 'transactionTypeCount', 'advertisements'));
  }
}
