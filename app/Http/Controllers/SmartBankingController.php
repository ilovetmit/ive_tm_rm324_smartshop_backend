...
class SmartBankingController extends Controller {
    ...
    public function dashboard() {
        return view('smart_banking.dashboard.index');
    }
    ...
    public function insurance() {
        $rows = Insurance::all();
        return view('smart_banking.insurance.index', compact('rows'));
    }

    public function insurance_detail($id) {
        $insurance = Insurance::find($id);
        return view('smart_banking.insurance.detail', compact('insurance'));
    }
...
//        session()->flash('message', $insurance->name . " (" . $type . ") Plan Subscribe successful!");
    ...
    public function login() {
        ...
        return view('smart_banking.login.text');
    }
    ...
    public function login_qr() {
        ...
        return view('smart_banking.login.qr', compact('token'));
    }
    ...
    public function stock() {
        $rows = Stock::all();
        return view('smart_banking.stock.index', compact('rows'));
    }
    ...
    public function transaction() {
        ...
        return view('smart_banking.transaction.index', compact('rows'));
    }
    ...
    public function transfer() {
        ...
        return view('smart_banking.transfer.index', compact('users'));
    }
