        ...
        <form method="POST" action="{{ route("TransactionManagement.Transactions.update", [$transaction->id]) }}"
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('header') ? 'is-invalid' : '' }}" type="text" name="header"
                    id="header" value="{{ old('header', $transaction->header) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control data {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="text"
                    name="amount" id="amount" value="{{ old('amount', $transaction->amount) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control data {{ $errors->has('balance') ? 'is-invalid' : '' }}" type="text"
                    name="balance" id="balance" value="{{ old('balance', $transaction->balance) }}" required>
