{{-- Parent Layout --}}
@extends('_layout.dark-admin-premium-1-4-5.master.smart_banking_layout')
                            ...
                            <div class="stats-2-block block d-flex pb-5">
                                <div class="stats-2 d-flex">
                                    ...
                                    <div class="stats-2-content"><strong class="d-block"
                                                                         id="yesterdayNum">5.657</strong><span
                                            class="d-block">Yesterday </span>
                                ...
                                <div class="stats-2 d-flex">
                                    ...
                                    <div class="stats-2-content"><strong class="d-block"
                                                                         id="todayNum">3.1459</strong><span
                            ...
                            @foreach($rows as $row)
                                <a href="javascript:setData('{{$row->code}}')" class="message d-flex align-items-center"
                                   onclick="setData('{{$row->code}}')">
                                    <div class="profile"><img src="{{$row->image[0]}}" alt="{{$row->name}}"
                                                              class="logo-photo">
                                    </div>
