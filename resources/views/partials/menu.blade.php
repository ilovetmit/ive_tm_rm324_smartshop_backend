            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview {{ request()->is('SmartShop/TransactionManagement*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route("TransactionManagement.RemittanceTransactions.index") }}" class="nav-link {{ request()->is('TransactionManagement/RemittanceTransactions*') ? 'active' : '' }}">
                                <i class="fa-fw fas fa-briefcase"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route("TransactionManagement.ProductTransactions.index") }}" class="nav-link {{ request()->is('TransactionManagement/ProductTransactions*') ? 'active' : '' }}">
                                <i class="fa-fw fas fa-user"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route("TransactionManagement.LockerTransactions.index") }}" class="nav-link {{ request()->is('TransactionManagement/LockerTransactions*') ? 'active' : '' }}">
                                <i class="fa-fw fas fa-user"></i>
                                <p>
                ...
                @endcan
                <!-- ExtraManagement -->
                @can('extra_management_access')
                <li class="nav-item">
                    <a href="{{ route("ExtraManagement.Stocks.index") }}" class="nav-link {{ request()->is('SmartShop/ExtraManagement/Stocks*') ? 'active' : '' }}">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <p>
                            <span>{{ trans('cruds.extraManagement.sub_title_1.title_s') }}</span>
                        </p>
                    </a>
                </li>
                @endcan
                @can('extra_management_access')
                <li class="nav-item">
                    <a href="{{ route("ExtraManagement.Insurances.index") }}" class="nav-link {{ request()->is('SmartShop/ExtraManagement/Insurances*') ? 'active' : '' }}">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <p>
                            <span>{{ trans('cruds.extraManagement.sub_title_2.title_s') }}</span>
                        </p>
                    </a>
                </li>
                @endcan
