...
<body style="overflow: hidden;">
    <div class="page-content w-100 pl-4 pt-4">
        <div class="row w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @php echo '
                                <pre
                                    class="m-0">'.json_encode($blockchains[$i]['data']['json'], JSON_PRETTY_PRINT).'</pre>
                                ' @endphp
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{gmdate('Y-m-d H:i:s', isset($blockchains[$i]['blocktime']) ? $blockchains[$i]['blocktime'] : 'NULL')}}
                                GMT{{ isset($blockchains[$i]['blocktime']) ? ' (confirmed ['.$blockchains[$i]["confirmations"].'])' : ''}}
                                @else
                                unconfirmed
                                @endif
                            </td>
            ...
            {{--                    </div>--}}
            {{--                    <div class="number dashtext-4">{{$productCount}}
        </div>--}}
        {{--                </div>--}}
        {{--                <div class="progress progress-template">--}}
        ...
        <div class="checklist-block mb-3">
            ...
            <div class="item d-flex align-items-center pt-3 pb-3">
                Locker #{{$locker['locker']->locker_id}} | Status: <strong class="ml-2">@if($locker['locker']->using==0)
        ...
        <div class="checklist-block mb-3">
            @for($i = 0;$i<=8;$i++) <div class="item d-flex align-items-center pt-3 pb-3">
                Channel #{{$i+1}} &nbsp|
                @if(!is_null($vendings[$i]['product'])) <i
                    class="fa fa-check text-success mr-2 ml-2"></i><strong>Normal</strong>
    ...
    <div class="col">
        ...
        <div class="row pl-3 pr-3 mb-3">
            <div class="col m-0 pl-0 pr-2">
                ...
                <input type="text" autocomplete="off" class="digit form-control" name="sensor1"
                    value="{{$ledSensor[0]/10}}">
            </div>
            <div class="col m-0 p-0">
                <label class="m-0">Humidity (%)</label>
                <input type="text" autocomplete="off" class="digit form-control" name="sensor2"
                    value="{{$ledSensor[1]/10}}">
            </div>
        </div>
