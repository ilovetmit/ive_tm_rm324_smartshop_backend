                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" placeholder="Username" value="VIP" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" placeholder="Saving Account"
                                        value="{{$user->hasBankAccount['saving_account']}}" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" placeholder="Current Account"
                                        value="{{$user->hasBankAccount['current_account']}}" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" placeholder="VitCoin" value="TODO" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
