                        ...
                        <div class="block-body">
                            <form id="transfer-form" class="form-horizontal" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="custom-select custom-select-lg col-sm-3 mb-3 bg-primary text-light" id="from_account" name="from">
...
{{--                                            <option value="VitCoin" class="vitcoin">VitCoin</option>--}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="custom-select custom-select-lg col-sm-6 mb-3 bg-primary text-light" id="to" name="to" required>
                                        ...
                                        <select class="custom-select custom-select-lg col-sm-3 mb-3 bg-primary text-light" id="to_account" name="to_account" required>
