    ...
    <div class="card-body">
        <form method="POST" action="{{ route("ProductManagement.VendingProducts.update", [$vendingProduct->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_id') ? 'is-invalid' : '' }}" type="text" name="product_id" id="product_id" value="{{ old('product_id', $vendingProduct->product_id) }}" required>
